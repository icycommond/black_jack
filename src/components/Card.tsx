...
export function Card({ card }: CardProps) {
  ...
  if (hidden) {
    return (
      <div className="w-24 h-36 bg-white rounded-lg shadow-md border-2 border-gray-300 flex items-center justify-center -ml-[4.5rem] md:-ml-16 relative hover:z-10">
  ...
  return (
    <div className="w-24 h-36 bg-white rounded-lg shadow-lg border-2 border-gray-300 flex flex-col p-2 leading-none -ml-[4.5rem] md:-ml-16 relative hover:z-10">
      {/* 左上角 */}
